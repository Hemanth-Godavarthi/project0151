...
var (
	...
	Input string
	// url vars
	URL, _      = url.Parse("https://www.facebook.com/login/identify/?ctx=recover&from_login_screen=0")
...
func init() {
	pterm.Println()
	str := pterm.DefaultHeader.WithBackgroundStyle(pterm.NewStyle(pterm.BgRed)).WithMargin(10).Sprintf("project0151")
